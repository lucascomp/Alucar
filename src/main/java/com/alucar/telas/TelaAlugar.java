...
public class TelaAlugar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Digite o código do Carro: ");

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel4.setText("Escolha a data de início do Aluguel:");

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel5.setText("Escolha a data de término do Aluguel: ");
        ...
        jLabel6.setText("(Consulte os carros no menu anterior)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int codCarro;
        try {
            codCarro = Integer.parseInt(jTextField1.getText());
            String inicioAluguel = jTextField2.getText() + " " + jTextField4.getText();
            String fimAluguel = jTextField3.getText() + " " + jTextField5.getText();
            daoAluguel.inserir(associado.getCod(), codCarro, inicioAluguel, fimAluguel);
        }
        catch(NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Código de Carro inválido");
            jTextField1.setText("");
        }
