...
public class TelaFatura extends javax.swing.JFrame {
    ...
    public TelaFatura(Associado associado) {
        this.associado = associado;
        initComponents();
        jLabel2.setText(associado.getLogin());
        DaoAluguel daoAluguel = new DaoAluguel();
        jLabel3.setText("Sua fatura deste mês, até o momento, é de: R$" + String.format("%.2f", daoAluguel.fatura(associado.getCod())) + ".");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Sua fatura deste mês, até o momento, é de: R$x");
