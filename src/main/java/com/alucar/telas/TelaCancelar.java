...
public class TelaCancelar extends javax.swing.JFrame {
    ...
    public TelaCancelar(Associado associado) {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Código do Aluguel a ser cancelado: ");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int codAluguel = Integer.parseInt(jTextField1.getText());
        DaoAluguel daoAluguel = new DaoAluguel();
        daoAluguel.cancelar(codAluguel, associado.getCod());
